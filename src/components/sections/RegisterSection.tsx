...
export default function RegisterSection() {
  ...
  const handleReset = () => {
    ...
    setForm({ name: "", phone1: "010", phone2: "", phone3: "", interestType: "", age: "" });
  };
      ...
      <div className="relative h-[50vh] min-h-[340px]">
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="text-center">
            ...
            <h1 className="text-white text-[36px] lg:text-[52px] font-extralight tracking-tight text-shadow-banner">방문예약</h1>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white">
        <div className="max-w-[640px] mx-auto px-6 py-16 lg:py-24">
          <div className="text-center mb-14">
            <h2 className="text-[26px] font-extralight text-charcoal tracking-tight mb-4">방문예약 신청</h2>
          ...
          <form onSubmit={handleSubmit} className="space-y-10">
            ...
            <div className="border border-gray-200">
              ...
              {privacyOpen && (
                <div className="px-6 pb-5 max-h-[240px] overflow-y-auto text-[12px] text-cool-gray leading-[1.9] space-y-3 border-t border-gray-100">
                  ...
                  <p><strong className="text-dark-gray">수집항목:</strong> 이름, 연락처, 관심타입, 방문 희망일시</p>
            ...
            {/* Interest Type */}
            <div>
              <label className="text-gold text-[10px] tracking-[3px] font-medium uppercase">관심타입</label>
            ...
            {/* Visit date & time */}
            <div>
              <label className="text-gold text-[10px] tracking-[3px] font-medium uppercase">방문일자 및 시간</label>
              <input
                type="datetime-local"
                value={form.age}
                ...
                className={inputBase}
              />
              <p className="text-cool-gray text-[11px] mt-1.5 font-light">방문을 희망하시는 날짜와 시간을 선택해 주세요</p>
            </div>
          ...
          <div className="mt-16 pt-10 border-t border-gray-100 text-center">
            ...
            <a href="tel:1844-1680" className="text-navy text-[24px] font-extralight tracking-widest hover:text-gold transition-colors">
              1844-1680
            </a>
          </div>
        </div>
