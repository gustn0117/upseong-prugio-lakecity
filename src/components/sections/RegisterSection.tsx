      ...
      <div className="relative h-[50vh] min-h-[340px]">
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="text-center">
            <p className="text-gold/60 text-[10px] tracking-[5px] font-medium uppercase mb-4">Register</p>
            <h1 className="text-white text-[36px] lg:text-[52px] font-extralight tracking-tight">관심고객등록</h1>
          </div>
        </div>
      </div>
